...
for destination in sheet_data:
    ...
    if cheapest_flight.price == "N/A":
        ...
        print(f"Cheapest indirect flight price is: CAD{cheapest_flight.price}")

# # ==================== Search for Flights for 6 months from Today ====================
...
#     cheapest_flight = find_cheapest_flight(flights)
#     print(f"{destination['city']}: CAD{cheapest_flight.price}")
#     # Slowing down requests to avoid rate limit (429 Error)
#     time.sleep(2)

#     if cheapest_flight.price != "N/A" and cheapest_flight.price < destination["lowestPrice"]:
#         print(f"Lower price flight found to {destination['city']}!")
        # notification_manager.send_sms(
        #     message_body=f"Low price alert! Only CAD{cheapest_flight.price} to fly "
